...
{{
    ...
    {{
");
                sourceBuilder.AppendLine("public static readonly Dictionary<Type, Type> ViewModelLookup = new Dictionary<Type, Type>()");
                ...
                foreach (var page in pages)
                {
                    ...
                    if (matches.Count == 1)
                        sourceBuilder.AppendLine($"{{ typeof({page.Name}), typeof({matches[0].Name}) }},");
